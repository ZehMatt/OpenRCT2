...
int NeatParameters::Load(std::ifstream& a_DataFile)
{
    std::string s,tf;
    do
    {
...
int NeatParameters::Load(const char* a_FileName)
{
...
void NeatParameters::Save(const char* filename)
{
...
void NeatParameters::Save(FILE* a_fstream)
{
...
extern "C" {
	...
	void neat_reset_parameter(Neat_Parameters *params)
	{
		static_cast<NEAT::NeatParameters*>(params)->Reset();
	}
