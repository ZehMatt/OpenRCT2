...
public:
	...
	size_t NumIndividuals() { return m_Individuals.size(); }
    ...
    Genome GetIndividual(NeatParameters& a_Parameters, RNG& a_RNG) const;
    ...
    void AdjustFitness(NeatParameters& a_Parameters);
    ...
    // Reproduction.
    void Reproduce(Population& a_Pop, NeatParameters& a_Parameters, RNG& a_RNG);

    void MutateGenome( bool t_baby_is_clone, Population &a_Pop, Genome &t_baby, NeatParameters& a_Parameters, RNG& a_RNG);
    ...
    Genome ReproduceOne(Population& a_Pop, NeatParameters& a_Parameters, RNG& a_RNG);
